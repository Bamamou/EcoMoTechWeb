...
export const solarPanelProducts: Product[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1613665813446-82a78c468a1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1147&q=80"
  },
  {
    id: "thin-film-300w",
    name: "ThinFilm Flex 300W Solar Panel",
    description: "Lightweight and flexible thin-film solar panel perfect for curved surfaces and portable applications.",
    features: [
    ...
    image: "https://images.unsplash.com/photo-1518495973542-4542b06a9d3a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80"
  },
  {
    id: "bifacial-500w",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1592833159155-c62df1b65634?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80"
  },
  {
    id: "smart-365w",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1525490829609-d166ddb58678?ixlib=rb-4.0.3&auto=format&fit=crop&w=1169&q=80"
  }
];
...
export const electricMotorcycleProducts: Product[] = [
  {
    id: "em-sport-8000",
    name: "SportRider 8000",
    description: "High-performance electric motorcycle with impressive range and speed capabilities.",
    features: [
  ...
  {
    id: "em-city-5000",
    name: "CityRunner 5000",
    description: "Perfect urban commuter with balanced performance and comfort.",
    features: [
    ...
    specifications: {
      ...
      "Battery Capacity": "60V 80Ah"
    },
    image: "https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80"
  }
];

// EV Charger Products
export const evChargerProducts: Product[] = [
  {
    id: "ev-home-11kw",
    name: "HomeCharge 11kW",
    description: "Smart home charging station with advanced features for all electric vehicles.",
    features: [
      "Wi-Fi connectivity",
  ...
  {
    id: "ev-dc-60kw",
    name: "FastCharge DC 60kW",
    description: "Commercial DC fast charging station for rapid charging needs.",
    features: [
    ...
    specifications: {
      "Power Output": "60kW DC",
      "Input Voltage": "400V AC",
      "Charging Protocol": "CCS/CHAdeMO",
      "IP Rating": "IP54",
      "Operating Temperature": "-25°C to +45°C"
    },
    image: "https://images.unsplash.com/photo-1696996727451-492f89f67d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1887&q=80"
  }
];
