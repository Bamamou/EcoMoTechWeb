    ...
    <article className="pt-16 pb-10 bg-gradient-to-br from-white via-blue-50 to-green-50">
      <div className="container mx-auto px-2 sm:px-4">
        <div className="max-w-3xl mx-auto mb-8">
          <Badge variant="secondary" className="mb-3 text-base px-3 py-2 bg-gradient-to-r from-blue-500 to-green-400 text-white shadow-lg">Product Launch</Badge>
          <h1 className="text-3xl sm:text-5xl font-extrabold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-green-600 to-emerald-400 drop-shadow-lg">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-gray-500 mb-6">
            ...
            <Separator orientation="vertical" className="mx-2 h-6 hidden sm:block" />
            <button
              className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-gradient-to-r from-blue-500 to-green-400 text-white font-semibold shadow-md hover:scale-105 transition-transform text-xs sm:text-sm"
              onClick={() => {
                if (navigator.share) {
                  navigator.share({
        ...
        <div className="max-w-3xl mx-auto space-y-10 sm:space-y-16">
          ...
          <div className="mt-12 flex flex-col items-center gap-6 sm:gap-8">
            <h3 className="text-xl sm:text-2xl font-bold text-center text-gray-800">Discover Our Products</h3>
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full justify-center">
              <button
                className="group relative inline-flex items-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 text-white font-bold text-sm sm:text-base shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 overflow-hidden backdrop-blur-sm w-full sm:w-auto"
                onClick={() => {
                  if (navigator.share) {
                    navigator.share({
                      title: 'EcoMotech Aurora Series',
              ...
              >
                ...
                <div className="relative z-10 flex items-center gap-2">
                  ...
                  <div className="flex flex-col items-start">
                    <span className="font-bold text-sm group-hover:text-yellow-100 transition-colors duration-300">Share Article</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 w-full justify-center">
              <a
                ...
                className="group relative flex-1 p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-400 text-white shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 overflow-hidden mb-4 sm:mb-0"
              >
                ...
                <div className="relative z-10 flex flex-col items-center text-center space-y-3 sm:space-y-4">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-2xl font-bold mb-1 sm:mb-2 group-hover:text-yellow-100 transition-colors duration-300">Solar Panels</h3>
                    <p className="text-blue-100 text-xs sm:text-sm opacity-90 group-hover:opacity-100 transition-opacity duration-300">
                      Discover our high-efficiency Aurora Series and premium solar solutions
                    </p>
                  </div>
                  <div className="flex items-center mt-2 sm:mt-4 text-xs sm:text-sm font-semibold group-hover:translate-x-2 transition-transform duration-300">
              ...
              <a
                ...
                className="group relative flex-1 p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-emerald-600 via-green-500 to-teal-400 text-white shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative z-10 flex flex-col items-center text-center space-y-3 sm:space-y-4">
                  <div className="p-3 sm:p-4 bg-white/20 rounded-full backdrop-blur-sm group-hover:bg-white/30 transition-colors duration-300">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-2xl font-bold mb-1 sm:mb-2 group-hover:text-green-100 transition-colors duration-300">Home Systems</h3>
                    <p className="text-emerald-100 text-xs sm:text-sm opacity-90 group-hover:opacity-100 transition-opacity duration-300">
